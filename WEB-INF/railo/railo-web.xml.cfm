<?xml version="1.0" encoding="UTF-8"?><railo-configuration password="dcbc2689ec5e4cdccdf499a97725349df5f8f11d19e47126" version="2.0"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;useUnicode=true" database="newproject" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="newproject" port="3306" storage="false" username="root" validate="false"/></data-sources>
	...
	<mapping physical="/Users/ujvaldez/dev/railo/webapps/newproject/orm-newproject" primary="physical" toplevel="true" trusted="false" virtual="/orm-newproject"/></mappings>	
